...
import { Building2, Users, FileText, Settings, LogOut, Menu, X, Briefcase, Calendar } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center justify-between h-14 px-4 bg-white border-b border-slate-200">
          ...
          <Link to="/" className="text-blue-600 text-sm font-medium">View Site</Link>
        </div>
